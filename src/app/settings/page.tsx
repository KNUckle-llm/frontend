    ...
    return (
        <div className="flex h-screen bg-white">
            ...
            <div className="w-16 bg-white border-r border-gray-100 flex flex-col items-center py-4">
                <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mb-8">
                    <span className="font-bold text-gray-800">KN</span>
                </div>
                <div className="flex flex-col items-center space-y-6">
                    <button className="w-10 h-10 flex items-center justify-center text-gray-400 hover:bg-gray-100 rounded-full">
                        <User size={20} />
                    </button>
                    <button className="w-10 h-10 flex items-center justify-center text-gray-400 hover:bg-gray-100 rounded-full">
                        <MessageSquare size={20} />
                    </button>
                    <button className="w-10 h-10 flex items-center justify-center text-gray-800 bg-gray-100 rounded-full">
                        <Settings size={20} />
                    </button>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 overflow-auto p-6 max-w-3xl mx-auto w-full">
                    <div className="space-y-8">
                        ...
                        {/* 시스템 프롬프트 설정 섹션 */}
                        <div className="space-y-4">
                            <h2 className="text-lg font-medium text-gray-800">시스템 프롬프트</h2>
                            <div className="p-4 bg-gray-50 rounded-lg space-y-4">
                                <div className="space-y-2">
                                    ...
                                    />
                                    <p className="text-xs text-gray-500">
                                        모든 대화에 적용될 시스템 프롬프트를 설정하세요. KNUckle의 기본 성향과 답변 방식을 정의합니다.
                                    </p>
                                </div>
                        ...
                        {/* 예시 프롬프트 템플릿 섹션 */}
                        <div className="space-y-4">
                            <h2 className="text-lg font-medium text-gray-800">프롬프트 템플릿</h2>
                            <div className="p-4 bg-gray-50 rounded-lg space-y-4">
                                <div className="space-y-2">
                                    <p className="text-sm text-gray-700">자주 사용하는 프롬프트 템플릿</p>
                                    ...
                                    <div className="p-3 border border-gray-200 bg-white rounded-md cursor-pointer hover:bg-gray-50">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">당신은 친절하고 도움이 되는 AI 비서입니다...</p>
                                    </div>

                                    <div className="p-3 border border-gray-200 bg-white rounded-md cursor-pointer hover:bg-gray-50">
                                        <p className="font-medium">코딩 어시스턴트</p>
                                        <p className="text-sm text-gray-500 truncate">당신은 코딩을 도와주는 프로그래밍 전문가입니다...</p>
                                    </div>
